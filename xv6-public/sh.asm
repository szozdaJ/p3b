...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 d6 0e 00 00       	call   f06 <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 69 0e 00 00       	call   ebe <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 67 0e 00 00       	call   ece <wait>
  printf(2, "$ ");
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 33 0e 00 00       	call   eee <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 41 0e 00 00       	call   f36 <chdir>
  ...
  exit();
     11a:	e8 a7 0d 00 00       	call   ec6 <exit>
    panic("fork");
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 3c 0d 00 00       	call   ec6 <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 23 0d 00 00       	call   ebe <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 1b 0d 00 00       	call   efe <exec>
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 c1 0c 00 00       	call   ec6 <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 b7 0c 00 00       	call   ed6 <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 9f 0c 00 00       	call   eee <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 96 0c 00 00       	call   eee <close>
    wait();
     258:	e8 71 0c 00 00       	call   ece <wait>
    wait();
     25d:	e8 6c 0c 00 00       	call   ece <wait>
    break;
    ...
    wait();
     270:	e8 59 0c 00 00       	call   ece <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 63 0c 00 00       	call   eee <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 6e 0c 00 00       	call   f06 <open>
    ...
    panic("runcmd");
     ...
     2c2:	e8 69 0d 00 00       	call   1030 <printf>
      exit();
     2c7:	e8 fa 0b 00 00       	call   ec6 <exit>
      panic("pipe");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 0b 0c 00 00       	call   eee <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 52 0c 00 00       	call   f3e <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 f9 0b 00 00       	call   eee <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 f0 0b 00 00       	call   eee <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 dd 0b 00 00       	call   eee <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 24 0c 00 00       	call   f3e <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 cb 0b 00 00       	call   eee <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 c2 0b 00 00       	call   eee <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 52 14 00 00       	push   $0x1452
  cmd = parseline(&s, es);
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 d1 01 00 00       	call   ede <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 94 01 00 00       	call   f06 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 97 01 00 00       	call   f1e <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 5d 01 00 00       	call   eee <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
	...
	void *stack; 
		ptr = malloc((PGSIZE*2));
     e26:	68 00 20 00 00       	push   $0x2000
     e2b:	e8 30 04 00 00       	call   1260 <malloc>

	if (ptr != 0) {
     e30:	83 c4 10             	add    $0x10,%esp
     e33:	85 c0                	test   %eax,%eax
     e35:	75 12                	jne    e49 <thread_create+0x29>
	...
	return clone(start_routine, arg1, arg2, stack);
     ...
     e42:	e8 1f 01 00 00       	call   f66 <clone>
}
     e47:	c9                   	leave  
     e48:	c3                   	ret    
     ...
     e49:	50                   	push   %eax
     e4a:	50                   	push   %eax
     e4b:	68 40 14 00 00       	push   $0x1440
     e50:	6a 01                	push   $0x1
     e52:	e8 d9 01 00 00       	call   1030 <printf>
	    exit();
     e57:	e8 6a 00 00 00       	call   ec6 <exit>
...
int thread_join()
{
     ...
     e63:	83 ec 24             	sub    $0x24,%esp
	void* stackPtr;
	int threadret = join(&stackPtr);
     e66:	8d 45 f4             	lea    -0xc(%ebp),%eax
     e69:	50                   	push   %eax
     e6a:	e8 ff 00 00 00       	call   f6e <join>
	return threadret;
}
     e6f:	c9                   	leave  
     e70:	c3                   	ret    
...
void lock_init(lock_t *lk)
{
	...
	lk->locked = 0;
     ...
     e86:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
     e8c:	5d                   	pop    %ebp
     e8d:	c3                   	ret    
     e8e:	66 90                	xchg   %ax,%ax

00000e90 <lock_acquire>:
...
SYSCALL(fork)
     ebe:	b8 01 00 00 00       	mov    $0x1,%eax
     ec3:	cd 40                	int    $0x40
     ec5:	c3                   	ret    

00000ec6 <exit>:
SYSCALL(exit)
     ec6:	b8 02 00 00 00       	mov    $0x2,%eax
     ecb:	cd 40                	int    $0x40
     ecd:	c3                   	ret    

00000ece <wait>:
SYSCALL(wait)
     ece:	b8 03 00 00 00       	mov    $0x3,%eax
     ed3:	cd 40                	int    $0x40
     ed5:	c3                   	ret    

00000ed6 <pipe>:
SYSCALL(pipe)
     ed6:	b8 04 00 00 00       	mov    $0x4,%eax
     edb:	cd 40                	int    $0x40
     edd:	c3                   	ret    

00000ede <read>:
SYSCALL(read)
     ede:	b8 05 00 00 00       	mov    $0x5,%eax
     ee3:	cd 40                	int    $0x40
     ee5:	c3                   	ret    

00000ee6 <write>:
SYSCALL(write)
     ee6:	b8 10 00 00 00       	mov    $0x10,%eax
     eeb:	cd 40                	int    $0x40
     eed:	c3                   	ret    

00000eee <close>:
SYSCALL(close)
     eee:	b8 15 00 00 00       	mov    $0x15,%eax
     ef3:	cd 40                	int    $0x40
     ef5:	c3                   	ret    

00000ef6 <kill>:
SYSCALL(kill)
     ef6:	b8 06 00 00 00       	mov    $0x6,%eax
     efb:	cd 40                	int    $0x40
     efd:	c3                   	ret    

00000efe <exec>:
SYSCALL(exec)
     efe:	b8 07 00 00 00       	mov    $0x7,%eax
     f03:	cd 40                	int    $0x40
     f05:	c3                   	ret    

00000f06 <open>:
SYSCALL(open)
     f06:	b8 0f 00 00 00       	mov    $0xf,%eax
     f0b:	cd 40                	int    $0x40
     f0d:	c3                   	ret    

00000f0e <mknod>:
SYSCALL(mknod)
     f0e:	b8 11 00 00 00       	mov    $0x11,%eax
     f13:	cd 40                	int    $0x40
     f15:	c3                   	ret    

00000f16 <unlink>:
SYSCALL(unlink)
     f16:	b8 12 00 00 00       	mov    $0x12,%eax
     f1b:	cd 40                	int    $0x40
     f1d:	c3                   	ret    

00000f1e <fstat>:
SYSCALL(fstat)
     f1e:	b8 08 00 00 00       	mov    $0x8,%eax
     f23:	cd 40                	int    $0x40
     f25:	c3                   	ret    

00000f26 <link>:
SYSCALL(link)
     f26:	b8 13 00 00 00       	mov    $0x13,%eax
     f2b:	cd 40                	int    $0x40
     f2d:	c3                   	ret    

00000f2e <mkdir>:
SYSCALL(mkdir)
     f2e:	b8 14 00 00 00       	mov    $0x14,%eax
     f33:	cd 40                	int    $0x40
     f35:	c3                   	ret    

00000f36 <chdir>:
SYSCALL(chdir)
     f36:	b8 09 00 00 00       	mov    $0x9,%eax
     f3b:	cd 40                	int    $0x40
     f3d:	c3                   	ret    

00000f3e <dup>:
SYSCALL(dup)
     f3e:	b8 0a 00 00 00       	mov    $0xa,%eax
     f43:	cd 40                	int    $0x40
     f45:	c3                   	ret    

00000f46 <getpid>:
SYSCALL(getpid)
     f46:	b8 0b 00 00 00       	mov    $0xb,%eax
     f4b:	cd 40                	int    $0x40
     f4d:	c3                   	ret    

00000f4e <sbrk>:
SYSCALL(sbrk)
     f4e:	b8 0c 00 00 00       	mov    $0xc,%eax
     f53:	cd 40                	int    $0x40
     f55:	c3                   	ret    

00000f56 <sleep>:
SYSCALL(sleep)
     f56:	b8 0d 00 00 00       	mov    $0xd,%eax
     f5b:	cd 40                	int    $0x40
     f5d:	c3                   	ret    

00000f5e <uptime>:
SYSCALL(uptime)
     f5e:	b8 0e 00 00 00       	mov    $0xe,%eax
     f63:	cd 40                	int    $0x40
     f65:	c3                   	ret    

00000f66 <clone>:
SYSCALL(clone)
     f66:	b8 16 00 00 00       	mov    $0x16,%eax
     f6b:	cd 40                	int    $0x40
     f6d:	c3                   	ret    

00000f6e <join>:
SYSCALL(join)
     f6e:	b8 17 00 00 00       	mov    $0x17,%eax
     f73:	cd 40                	int    $0x40
     f75:	c3                   	ret    
     ...
     f8c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     fb9:	0f b6 92 b4 14 00 00 	movzbl 0x14b4(%edx),%edx
  ...
  write(fd, &c, 1);
     ...
     ffe:	56                   	push   %esi
     fff:	57                   	push   %edi
    1000:	e8 e1 fe ff ff       	call   ee6 <write>
  while(--i >= 0)
    ...
    1039:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1075:	57                   	push   %edi
    1076:	56                   	push   %esi
    1077:	e8 6a fe ff ff       	call   ee6 <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    10a9:	ff 24 85 5c 14 00 00 	jmp    *0x145c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    10ce:	e8 13 fe ff ff       	call   ee6 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10df:	57                   	push   %edi
    10e0:	56                   	push   %esi
    10e1:	e8 00 fe ff ff       	call   ee6 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    114b:	57                   	push   %edi
    114c:	56                   	push   %esi
    114d:	e8 94 fd ff ff       	call   ee6 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    118f:	e8 52 fd ff ff       	call   ee6 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    11b7:	90                   	nop
          s = "(null)";
    11b8:	ba 53 14 00 00       	mov    $0x1453,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11d1:	a1 a4 1b 00 00       	mov    0x1ba4,%eax
{
  ...
  freep = p;
    ...
    1211:	5b                   	pop    %ebx
  freep = p;
    1212:	89 15 a4 1b 00 00    	mov    %edx,0x1ba4
}
    1218:	5e                   	pop    %esi
    1219:	5f                   	pop    %edi
    121a:	5d                   	pop    %ebp
  ...
  freep = p;
    124c:	89 15 a4 1b 00 00    	mov    %edx,0x1ba4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    126c:	8b 3d a4 1b 00 00    	mov    0x1ba4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    12df:	8b 15 a4 1b 00 00    	mov    0x1ba4,%edx
    ...
    130c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    130f:	89 15 a4 1b 00 00    	mov    %edx,0x1ba4
}
    ...
    131f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1320:	c7 05 a4 1b 00 00 a8 	movl   $0x1ba8,0x1ba4
    1327:	1b 00 00 
    base.s.size = 0;
    132a:	bf a8 1b 00 00       	mov    $0x1ba8,%edi
    base.s.ptr = freep = prevp = &base;
    132f:	c7 05 a8 1b 00 00 a8 	movl   $0x1ba8,0x1ba8
    1336:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1339:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    133b:	c7 05 ac 1b 00 00 00 	movl   $0x0,0x1bac
    1342:	00 00 00 
    if(p->s.size >= nunits){
