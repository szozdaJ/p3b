...
main(int argc, char *argv[])
{
  ...
  55:	e8 34 06 00 00       	call   68e <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 38 06 00 00       	call   6a6 <open>
  ...
  81:	e8 4a 07 00 00       	call   7d0 <printf>
      exit();
  86:	e8 db 05 00 00       	call   666 <exit>
  }
  exit();
  8b:	e8 d6 05 00 00       	call   666 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  ...
  99:	e8 32 07 00 00       	call   7d0 <printf>
    exit();
  9e:	e8 c3 05 00 00       	call   666 <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 b4 05 00 00       	call   666 <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 208:	e8 71 04 00 00       	call   67e <read>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 f5 03 00 00       	call   686 <write>
 ...
 499:	31 db                	xor    %ebx,%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 d1 01 00 00       	call   67e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 50d:	e8 94 01 00 00       	call   6a6 <open>
  if(fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 97 01 00 00       	call   6be <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 5d 01 00 00       	call   68e <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 5cb:	e8 30 04 00 00       	call   a00 <malloc>

	if (ptr != 0) {
 5d0:	83 c4 10             	add    $0x10,%esp
 5d3:	85 c0                	test   %eax,%eax
 5d5:	75 12                	jne    5e9 <thread_create+0x29>
 ...
 5e2:	e8 1f 01 00 00       	call   706 <clone>
}
 5e7:	c9                   	leave  
 5e8:	c3                   	ret    
 ...
 5e9:	50                   	push   %eax
 5ea:	50                   	push   %eax
 5eb:	68 2e 0b 00 00       	push   $0xb2e
 5f0:	6a 01                	push   $0x1
 5f2:	e8 d9 01 00 00       	call   7d0 <printf>
	    exit();
 5f7:	e8 6a 00 00 00       	call   666 <exit>
...
int thread_join()
{
 ...
 609:	50                   	push   %eax
 60a:	e8 ff 00 00 00       	call   70e <join>
	return threadret;
}
 60f:	c9                   	leave  
 610:	c3                   	ret    
 ...
 72c:	89 d1                	mov    %edx,%ecx
{
 ...
 759:	0f b6 92 a0 0b 00 00 	movzbl 0xba0(%edx),%edx
 ...
 79e:	56                   	push   %esi
 79f:	57                   	push   %edi
 7a0:	e8 e1 fe ff ff       	call   686 <write>
  while(--i >= 0)
 ...
 7d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 815:	57                   	push   %edi
 816:	56                   	push   %esi
 817:	e8 6a fe ff ff       	call   686 <write>
 ...
 849:	ff 24 85 48 0b 00 00 	jmp    *0xb48(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 86e:	e8 13 fe ff ff       	call   686 <write>
        putc(fd, c);
 ...
 87f:	57                   	push   %edi
 880:	56                   	push   %esi
 881:	e8 00 fe ff ff       	call   686 <write>
        putc(fd, c);
 ...
 8eb:	57                   	push   %edi
 8ec:	56                   	push   %esi
 8ed:	e8 94 fd ff ff       	call   686 <write>
        while(*s != 0){
 ...
 92c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 92f:	e8 52 fd ff ff       	call   686 <write>
        ap++;
 ...
 957:	90                   	nop
          s = "(null)";
 958:	ba 41 0b 00 00       	mov    $0xb41,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 971:	a1 00 14 00 00       	mov    0x1400,%eax
{
 ...
 9b1:	5b                   	pop    %ebx
  freep = p;
 9b2:	89 15 00 14 00 00    	mov    %edx,0x1400
}
 9b8:	5e                   	pop    %esi
 9b9:	5f                   	pop    %edi
 9ba:	5d                   	pop    %ebp
 ...
 9e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9ec:	89 15 00 14 00 00    	mov    %edx,0x1400
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 a09:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 a0c:	8b 3d 00 14 00 00    	mov    0x1400,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a4f:	73 4f                	jae    aa0 <malloc+0xa0>
    ...
    if(p == freep)
 a51:	8b 3d 00 14 00 00    	mov    0x1400,%edi
 ...
 a63:	e8 86 fc ff ff       	call   6ee <sbrk>
  if(p == (char*)-1)
 ...
 a7a:	e8 f1 fe ff ff       	call   970 <free>
  return freep;
 a7f:	8b 15 00 14 00 00    	mov    0x1400,%edx
 ...
 aac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 aaf:	89 15 00 14 00 00    	mov    %edx,0x1400
}
 ...
 abf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 ac0:	c7 05 00 14 00 00 04 	movl   $0x1404,0x1400
 ac7:	14 00 00 
    base.s.size = 0;
 aca:	bf 04 14 00 00       	mov    $0x1404,%edi
    base.s.ptr = freep = prevp = &base;
 acf:	c7 05 04 14 00 00 04 	movl   $0x1404,0x1404
 ad6:	14 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ad9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 adb:	c7 05 08 14 00 00 00 	movl   $0x0,0x1408
 ae2:	00 00 00 
    if(p->s.size >= nunits){
