...
main(int argc, char **argv)
{
  ...
  39:	e8 48 03 00 00       	call   386 <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 0c 03 00 00       	call   356 <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 68 04 00 00       	call   4c0 <printf>
    exit();
  58:	e8 f9 02 00 00       	call   356 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 d1 01 00 00       	call   36e <read>
    if(cc < 1)
...
int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 2bb:	e8 30 04 00 00       	call   6f0 <malloc>

	if (ptr != 0) {
 2c0:	83 c4 10             	add    $0x10,%esp
 2c3:	85 c0                	test   %eax,%eax
 2c5:	75 12                	jne    2d9 <thread_create+0x29>
 ...
 2d2:	e8 1f 01 00 00       	call   3f6 <clone>
}
 2d7:	c9                   	leave  
 2d8:	c3                   	ret    
 ...
 2d9:	50                   	push   %eax
 2da:	50                   	push   %eax
 2db:	68 fc 07 00 00       	push   $0x7fc
 2e0:	6a 01                	push   $0x1
 2e2:	e8 d9 01 00 00       	call   4c0 <printf>
	    exit();
 2e7:	e8 6a 00 00 00       	call   356 <exit>
...
int thread_join()
{
 ...
 2f9:	50                   	push   %eax
 2fa:	e8 ff 00 00 00       	call   3fe <join>
	return threadret;
}
 2ff:	c9                   	leave  
 300:	c3                   	ret    
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 70 08 00 00 	movzbl 0x870(%edx),%edx
 ...
 48e:	56                   	push   %esi
 48f:	57                   	push   %edi
 490:	e8 e1 fe ff ff       	call   376 <write>
  while(--i >= 0)
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 505:	57                   	push   %edi
 506:	56                   	push   %esi
 507:	e8 6a fe ff ff       	call   376 <write>
 ...
 539:	ff 24 85 18 08 00 00 	jmp    *0x818(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 55e:	e8 13 fe ff ff       	call   376 <write>
        putc(fd, c);
 ...
 56f:	57                   	push   %edi
 570:	56                   	push   %esi
 571:	e8 00 fe ff ff       	call   376 <write>
        putc(fd, c);
 ...
 5db:	57                   	push   %edi
 5dc:	56                   	push   %esi
 5dd:	e8 94 fd ff ff       	call   376 <write>
        while(*s != 0){
 ...
 61c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 61f:	e8 52 fd ff ff       	call   376 <write>
        ap++;
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 0f 08 00 00       	mov    $0x80f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 cc 0b 00 00       	mov    0xbcc,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 cc 0b 00 00    	mov    %edx,0xbcc
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 cc 0b 00 00    	mov    %edx,0xbcc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d cc 0b 00 00    	mov    0xbcc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d cc 0b 00 00    	mov    0xbcc,%edi
 ...
 753:	e8 86 fc ff ff       	call   3de <sbrk>
  if(p == (char*)-1)
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 cc 0b 00 00    	mov    0xbcc,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 cc 0b 00 00    	mov    %edx,0xbcc
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 cc 0b 00 00 d0 	movl   $0xbd0,0xbcc
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf d0 0b 00 00       	mov    $0xbd0,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 d0 0b 00 00 d0 	movl   $0xbd0,0xbd0
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 d4 0b 00 00 00 	movl   $0x0,0xbd4
 7d2:	00 00 00 
    if(p->s.size >= nunits){
